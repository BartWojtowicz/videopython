...
TextToVideoBackend = Literal["local", "runway", "luma", "replicate"]
ImageToVideoBackend = Literal["local", "runway", "luma", "replicate"]
TextToSpeechBackend = Literal["local", "openai", "elevenlabs"]
TextToMusicBackend = Literal["local", "replicate"]
TextToImageBackend = Literal["local", "openai", "replicate"]
